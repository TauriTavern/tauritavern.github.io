---
description: 面向预设、角色卡和玩法创作者的 TauriTavern Agent 适配建议。
---
...
- 如果你主要维护 PromptManager 预设，阅读 [预设作者指南](/agent/preset-authors)。
- 如果你希望从扩展中启动后台 Agent 工作流，阅读 [扩展作者指南](/agent/extension-authors)。
